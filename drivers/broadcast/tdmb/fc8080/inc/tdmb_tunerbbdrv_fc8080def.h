...
extern    int8 tunerbb_drv_fc8080_select_antenna(unsigned int sel);
extern    int8 tunerbb_drv_fc8080_set_nation(unsigned int nation);
extern    int8 tunerbb_drv_fc8080_init(void);
extern    int8 tunerbb_drv_fc8080_stop(void);
extern    int8 tunerbb_drv_fc8080_get_ber(struct broadcast_tdmb_sig_info *dmb_bb_info);
extern  int8 tunerbb_drv_fc8080_get_msc_ber(uint32 *msc_ber);
extern    int8 tunerbb_drv_fc8080_set_channel(int32 freq_num, uint8 subch_id, uint8 op_mode);
extern    int8 tunerbb_drv_fc8080_re_syncdetector(uint8 op_mode);
extern    int8 tunerbb_drv_fc8080_re_sync(void);
extern    int8 tunerbb_drv_fc8080_get_fic(uint8* buffer, uint32* buffer_size);
extern    int8 tunerbb_drv_fc8080_control_fic(uint8 enable);
extern    int8 tunerbb_drv_fc8080_read_data(uint8* buffer, uint32* buffer_size);
extern    int8 tunerbb_drv_fc8080_multi_set_channel(int32 freq_num, uint8 subch_cnt, uint8 subch_id[ ], uint8 op_mode[ ]);
extern    int8 tunerbb_drv_fc8080_process_multi_data(uint8 subch_cnt,uint8* input_buf, uint32 input_size, uint32* read_size);
extern     int8 tunerbb_drv_fc8080_get_multi_data(uint8 subch_cnt, uint8* buf_ptr, uint32 buf_size);
extern    int8 tunerbb_drv_fc8080_start_tii(void);
extern    int8 tunerbb_drv_fc8080_check_tii(uint8 * pmain_tii,uint8 * psub_tii);
