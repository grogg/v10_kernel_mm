...
int broadcast_fc8080_drv_if_power_off(void)
{
    int8 res = ERROR;
    boolean retval = FALSE;
...
int broadcast_fc8080_drv_if_init(void)
{
    int8 res = ERROR;
    boolean retval = FALSE;
...
int broadcast_fc8080_drv_if_stop(void)
{
    int8 res = ERROR;
...
int broadcast_fc8080_drv_if_detect_sync(int op_mode)
{
    int8 rc = ERROR;
    boolean retval = FALSE;
...
int broadcast_fc8080_drv_if_get_sig_info(struct broadcast_tdmb_sig_info *dmb_bb_info)
{
    int rc = ERROR;
    boolean retval = FALSE;
...
int broadcast_fc8080_drv_if_get_fic(char* buffer, unsigned int* buffer_size)
{
    int rc = ERROR;
    boolean retval = FALSE;
...
int broadcast_fc8080_drv_if_get_msc(char** buffer_ptr, unsigned int* buffer_size, unsigned int user_buffer_size)
{
    if(gpMPI_Buffer == NULL)
    {
...
int broadcast_fc8080_drv_if_reset_ch(void)
{
    int8 res = ERROR;
    boolean retval = FALSE;
...
int broadcast_fc8080_drv_if_user_stop(int mode)
{
    tunerbb_drv_fc8080_set_userstop(mode);
    return OK;
}

int broadcast_fc8080_drv_if_select_antenna(unsigned int sel)
{
    tunerbb_drv_fc8080_select_antenna(sel);
    return OK;
}

int broadcast_fc8080_drv_if_set_nation(unsigned int nation)
{
    tunerbb_drv_fc8080_set_nation(nation);
    return OK;
}

int broadcast_fc8080_drv_if_isr(void)
{
